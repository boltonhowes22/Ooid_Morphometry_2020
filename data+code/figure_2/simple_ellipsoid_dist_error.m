function [major_length, minor_length] = simple_ellipsoid_dist_error(major_axis, aspect_ratio_ac, aspect_ratio_bc , max_num_layers, number_obs, nuc_bool, nuc_percent)
% Makes a defined elliposoid, then cuts with a randomly oriented and placed
% plane to observe the errors of 2D measurements on 3D objects. For
% distributions. 
% a<b<c
% IN
